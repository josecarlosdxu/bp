    ...
    var panelContent,
        ...
        /*setPanelsHeight = function(hgt) {
            ...
            while(len > -1) {
               ...
               if(hasClass(panelContent, 'fixedTableContent') || hasClass(panelContent, 'fixedContent')){
                     hgt = hgt-45;

               }
               if(hasClass(panelContent, 'fixedTableContent--bigHeader')){
                hgt = hgt+45;

               }
               /*if(hasClass(panelContent, 'fixedTableContent--singleRow')){
                hgt = hgt-90;
        ...
        revealPanel = function (e) {
            ...
            if (hasClass(elem, 'form-checkbox') || hasClass(elem,'table-item--checkbox') || hasClass(elem, 'table-item--handler')) {
                //selectRow(elem);
                return;
            }           

            panel01.classList.replace('panel--active','panel--inactive');          
            panel02.classList.toggle('panel--inactive');
            panel02.classList.toggle('panel--active');
            panel02.classList.toggle('panel--secondary--reveal'); 
        ...
        setElems = function () {
            ...
            [].slice.call(document.querySelectorAll(toggleTabPattern)).map( function(e){
                e.addEventListener('click', hidePanel, false);
