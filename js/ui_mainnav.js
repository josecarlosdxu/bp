var mainNavClick = (function (window, undefined) {
    ...
    var nodeList,
        ...
        attributeValue = 'link',
        mainNavSelectedClass = 'mainNav-link--selected',
        bigMenuSelectedDisplay = 'flex',
        hideMenu = function () {
            itemSelected.bigMenu.removeAttribute('style');
            removeClass(itemSelected, mainNavSelectedClass);
        },
        showMenu = function (elem) {
            elem.bigMenu.style.display = bigMenuSelectedDisplay;
            bigMenu.init(elem.bigMenu);
            addClass(elem, mainNavSelectedClass);
            itemSelected = elem;
        },
